import{I as b,j as L,J as P,_ as E,f as R,p as D,O as N,u as U,o as p,c as d,K as z,$ as H,a as m,D as y,X as k,F as O,l as I,m as A,t as v,a0 as M}from"./app.c31b3cc5.js";const ne={},B=[{path:"/",title:"",pathLocale:"/",contents:[{header:"Vue 3 Google Login",content:""},{header:"Overview",slug:"overview",content:`This is a lightweight plugin to implement log-in and sign-up flows using Google Identity Services with the help of Google 3P Authorization JavaScript Library
...
`},...l],page:e,content:null,parentPagePriority:10,priority:10})}}function w(e){const o=e.path.split("/");let a="/";return o[1]&&(a=`/${o[1]}/`),(x.value.get(a)||e).title}function T(e,o){const a=[];let i=0;const u=e.toLowerCase().replace(/\s/gu," ");let l=0,c=u.indexOf(o,l);if(c<0)return null;for(;c>=0;){const t=c+o.length;if(n(e.slice(l,c),"normal"),n(e.slice(c,t),"highlight"),l=t,c=u.indexOf(o,l),i>100)break}return n(e.slice(l),"normal"),a.filter(t=>t.str);function n(t,s){let r=t;s==="normal"&&r.length>100&&i===0&&(r=`\u2026 ${r.slice(-10)}`);let h=!1;if(i+r.length>100){if(a.some(f=>f.type==="ellipsis"))return;r=r.slice(0,Math.max(100-i,1)),h=!0}a.push({type:s,str:r}),i+=r.length,h&&(a.push({type:"ellipsis",str:" \u2026"}),i+=2)}}const $={},Y=R({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>$}},setup(e){const{locales:o}=D(e),a=b(""),i=b(!1),u=b(-1),l=J(a),c=L(()=>a.value&&i.value&&l.value.length),n=N(),t=U(),s=L(()=>{var g;return(g=o.value[t.value])!=null?g:{}});function r(){if(!c.value)return;let g=u.value-1;g<0&&(g=l.value.length-1),f(g)}function h(){if(!c.value)return;let g=u.value+1;g>=l.value.length&&(g=0),f(g)}function f(g){u.value=g}function S(){u.value=-1}function _(g){if(!c.value)return;const G=l.value[g];G&&n.push(G.path)}return{query:a,focused:i,focusIndex:u,suggestions:l,activeSuggestion:c,onUp:r,onDown:h,focus:f,unfocus:S,go:_,locale:s}}}),q={class:"search-box",role:"search"},K=["placeholder"],W=["onMousedown","onMouseenter"],V=["href"],Q={key:0,class:"parent-page-title"},X={class:"suggestion-row"},Z={class:"page-title"},ee={class:"suggestion-content"};function oe(e,o,a,i,u,l){var c;return p(),d("div",q,[z(m("input",{ref:"input","onUpdate:modelValue":o[0]||(o[0]=n=>e.query=n),"aria-label":"Search",class:y({focused:e.focused}),placeholder:(c=e.locale.placeholder)!=null?c:"Search",autocomplete:"off",spellcheck:"false",onFocus:o[1]||(o[1]=()=>e.focused=!0),onBlur:o[2]||(o[2]=()=>e.focused=!1),onKeyup:[o[3]||(o[3]=k(n=>e.go(e.focusIndex),["enter"])),o[4]||(o[4]=k((...n)=>e.onUp&&e.onUp(...n),["up"])),o[5]||(o[5]=k((...n)=>e.onDown&&e.onDown(...n),["down"]))]},null,42,K),[[H,e.query]]),e.activeSuggestion?(p(),d("ul",{key:0,class:"suggestions",onMouseleave:o[7]||(o[7]=(...n)=>e.unfocus&&e.unfocus(...n))},[(p(!0),d(O,null,I(e.suggestions,(n,t)=>(p(),d("li",{key:t,class:y(["suggestion",{focused:t===e.focusIndex}]),onMousedown:s=>e.go(t),onMouseenter:s=>e.focus(t)},[m("a",{href:n.path,onClick:o[6]||(o[6]=M(()=>{},["prevent"]))},[n.parentPageTitle&&(!e.suggestions[t-1]||e.suggestions[t-1].parentPageTitle!==n.parentPageTitle)?(p(),d("div",Q,v(n.parentPageTitle),1)):A("",!0),m("div",X,[m("div",Z,v(n.title||n.path),1),m("div",ee,[(p(!0),d(O,null,I(n.display,(s,r)=>(p(),d("span",{key:r,class:y(s.type)},v(s.str),3))),128))])])],8,V)],42,W))),128))],32)):A("",!0)])}var ie=E(Y,[["render",oe],["__scopeId","data-v-5cdeda06"],["__file","SearchBox.vue"]]);export{ie as default};

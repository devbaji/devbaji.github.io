import{I as y,j as L,J as P,_ as D,f as E,p as N,u as R,o as p,c as d,K as U,$ as x,a as m,D as b,X as k,F as O,l as I,m as S,O as z,t as v,a0 as M}from"./app.4618facc.js";const ne={},H=[{path:"/",title:"",pathLocale:"/",contents:[{header:"Vue 3 Google Login - Complete Documentation",content:""},{header:"Overview",slug:"overview",content:`vue3-google-login is a lightweight, production-ready Vue 3 plugin for implementing Google Sign In, Google authentication, and OAuth2 login flows in your Vue 3 applications. This package provides seamless integration with Google Identity Services and the Google 3P Authorization JavaScript Library, making it easy to add Google login functionality to your Vue 3 projects.
...
Description clientId
String
Google API client ID`}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],B="update-vuepress-plugin-full-text-search2-search-index";var G=y(H),V=L(()=>{const e=new Map;for(const o of G.value)e.set(o.path,o);return e});ne.webpackHot&&(__VUE_HMR_RUNTIME__[B]=e=>{G.value=e});function F(e){const o=y([]);let s=null;return P(e,()=>{s&&clearTimeout(s),s=setTimeout(i,100)}),o;function i(){const c=e.value.toLowerCase().trim();if(!c){o.value=[];return}const l=new Map,u=new Set;for(const t of G.value)for(const a of j(t,c)){u.add(a.parentPageTitle);let r=l.get(a.parentPageTitle);r||(r=[],l.set(a.parentPageTitle,r)),r.push(a)}const n=[...u].sort((t,a)=>{const r=l.get(t);return l.get(a).length-r.length});o.value=[...l].flatMap(([,t])=>t).sort((t,a)=>t.parentPagePriority-a.parentPagePriority||n.indexOf(t.parentPageTitle)-n.indexOf(a.parentPageTitle)||t.priority-a.priority)}}function*j(e,o){const s=T(e.title,o);if(s){yield{path:e.path,parentPageTitle:w(e),title:e.title,display:s,page:e,content:null,parentPagePriority:1,priority:1};return}for(const i of e.contents){const c=T(i.header,o);if(c){yield{path:e.path+(i.slug?`#${i.slug}`:""),parentPageTitle:w(e),title:e.title,display:c,page:e,content:null,parentPagePriority:10,priority:2};continue}const l=T(i.content,o);l&&(yield{path:e.path+(i.slug?`#${i.slug}`:""),parentPageTitle:w(e),title:e.title,display:[{type:"header",str:`${i.header}
`},...l],page:e,content:null,parentPagePriority:10,priority:10})}}function w(e){const o=e.path.split("/");let s="/";return o[1]&&(s=`/${o[1]}/`),(V.value.get(s)||e).title}function T(e,o){const s=[];let i=0;const c=e.toLowerCase().replace(/\s/gu," ");let l=0,u=c.indexOf(o,l);if(u<0)return null;for(;u>=0;){const t=u+o.length;if(n(e.slice(l,u),"normal"),n(e.slice(u,t),"highlight"),l=t,u=c.indexOf(o,l),i>100)break}return n(e.slice(l),"normal"),s.filter(t=>t.str);function n(t,a){let r=t;a==="normal"&&r.length>100&&i===0&&(r=`\u2026 ${r.slice(-10)}`);let h=!1;if(i+r.length>100){if(s.some(f=>f.type==="ellipsis"))return;r=r.slice(0,Math.max(100-i,1)),h=!0}s.push({type:a,str:r}),i+=r.length,h&&(s.push({type:"ellipsis",str:" \u2026"}),i+=2)}}const J={},Y=E({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>J}},setup(e){const{locales:o}=N(e),s=y(""),i=y(!1),c=y(-1),l=F(s),u=L(()=>s.value&&i.value&&l.value.length),n=z(),t=R(),a=L(()=>{var g;return(g=o.value[t.value])!=null?g:{}});function r(){if(!u.value)return;let g=c.value-1;g<0&&(g=l.value.length-1),f(g)}function h(){if(!u.value)return;let g=c.value+1;g>=l.value.length&&(g=0),f(g)}function f(g){c.value=g}function A(){c.value=-1}function _(g){if(!u.value)return;const C=l.value[g];C&&n.push(C.path)}return{query:s,focused:i,focusIndex:c,suggestions:l,activeSuggestion:u,onUp:r,onDown:h,focus:f,unfocus:A,go:_,locale:a}}}),q={class:"search-box",role:"search"},$=["placeholder"],K=["onMousedown","onMouseenter"],W=["href"],Q={key:0,class:"parent-page-title"},X={class:"suggestion-row"},Z={class:"page-title"},ee={class:"suggestion-content"};function oe(e,o,s,i,c,l){var u;return p(),d("div",q,[U(m("input",{ref:"input","onUpdate:modelValue":o[0]||(o[0]=n=>e.query=n),"aria-label":"Search",class:b({focused:e.focused}),placeholder:(u=e.locale.placeholder)!=null?u:"Search",autocomplete:"off",spellcheck:"false",onFocus:o[1]||(o[1]=()=>e.focused=!0),onBlur:o[2]||(o[2]=()=>e.focused=!1),onKeyup:[o[3]||(o[3]=k(n=>e.go(e.focusIndex),["enter"])),o[4]||(o[4]=k((...n)=>e.onUp&&e.onUp(...n),["up"])),o[5]||(o[5]=k((...n)=>e.onDown&&e.onDown(...n),["down"]))]},null,42,$),[[x,e.query]]),e.activeSuggestion?(p(),d("ul",{key:0,class:"suggestions",onMouseleave:o[7]||(o[7]=(...n)=>e.unfocus&&e.unfocus(...n))},[(p(!0),d(O,null,I(e.suggestions,(n,t)=>(p(),d("li",{key:t,class:b(["suggestion",{focused:t===e.focusIndex}]),onMousedown:a=>e.go(t),onMouseenter:a=>e.focus(t)},[m("a",{href:n.path,onClick:o[6]||(o[6]=M(()=>{},["prevent"]))},[n.parentPageTitle&&(!e.suggestions[t-1]||e.suggestions[t-1].parentPageTitle!==n.parentPageTitle)?(p(),d("div",Q,v(n.parentPageTitle),1)):S("",!0),m("div",X,[m("div",Z,v(n.title||n.path),1),m("div",ee,[(p(!0),d(O,null,I(n.display,(a,r)=>(p(),d("span",{key:r,class:b(a.type)},v(a.str),3))),128))])])],8,W)],42,K))),128))],32)):S("",!0)])}var ie=D(Y,[["render",oe],["__scopeId","data-v-5cdeda06"],["__file","SearchBox.vue"]]);export{ie as default};

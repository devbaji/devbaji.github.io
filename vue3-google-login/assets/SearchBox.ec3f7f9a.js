import{I as b,j as L,J as P,_ as E,f as R,p as D,O as N,u as U,o as p,c as d,K as z,$ as H,a as m,D as y,X as k,F as G,l as I,m as A,t as w,a0 as M}from"./app.648a063a.js";const ne={},B=[{path:"/",title:"",pathLocale:"/",contents:[{header:"Vue 3 Google Login",content:""},{header:"Overview",slug:"overview",content:`This is a lightweight plugin to implement log-in and sign-up flows using Google Identity Services with the help of Google 3P Authorization JavaScript Library
...
Description clientId
String
Google API client ID`}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],F="update-vuepress-plugin-full-text-search2-search-index";var C=b(B),x=L(()=>{const e=new Map;for(const o of C.value)e.set(o.path,o);return e});ne.webpackHot&&(__VUE_HMR_RUNTIME__[F]=e=>{C.value=e});function J(e){const o=b([]);let a=null;return P(e,()=>{a&&clearTimeout(a),a=setTimeout(i,100)}),o;function i(){const u=e.value.toLowerCase().trim();if(!u){o.value=[];return}const l=new Map,c=new Set;for(const t of C.value)for(const s of j(t,u)){c.add(s.parentPageTitle);let r=l.get(s.parentPageTitle);r||(r=[],l.set(s.parentPageTitle,r)),r.push(s)}const n=[...c].sort((t,s)=>{const r=l.get(t);return l.get(s).length-r.length});o.value=[...l].flatMap(([,t])=>t).sort((t,s)=>t.parentPagePriority-s.parentPagePriority||n.indexOf(t.parentPageTitle)-n.indexOf(s.parentPageTitle)||t.priority-s.priority)}}function*j(e,o){const a=T(e.title,o);if(a){yield{path:e.path,parentPageTitle:v(e),title:e.title,display:a,page:e,content:null,parentPagePriority:1,priority:1};return}for(const i of e.contents){const u=T(i.header,o);if(u){yield{path:e.path+(i.slug?`#${i.slug}`:""),parentPageTitle:v(e),title:e.title,display:u,page:e,content:null,parentPagePriority:10,priority:2};continue}const l=T(i.content,o);l&&(yield{path:e.path+(i.slug?`#${i.slug}`:""),parentPageTitle:v(e),title:e.title,display:[{type:"header",str:`${i.header}
`},...l],page:e,content:null,parentPagePriority:10,priority:10})}}function v(e){const o=e.path.split("/");let a="/";return o[1]&&(a=`/${o[1]}/`),(x.value.get(a)||e).title}function T(e,o){const a=[];let i=0;const u=e.toLowerCase().replace(/\s/gu," ");let l=0,c=u.indexOf(o,l);if(c<0)return null;for(;c>=0;){const t=c+o.length;if(n(e.slice(l,c),"normal"),n(e.slice(c,t),"highlight"),l=t,c=u.indexOf(o,l),i>100)break}return n(e.slice(l),"normal"),a.filter(t=>t.str);function n(t,s){let r=t;s==="normal"&&r.length>100&&i===0&&(r=`\u2026 ${r.slice(-10)}`);let h=!1;if(i+r.length>100){if(a.some(f=>f.type==="ellipsis"))return;r=r.slice(0,Math.max(100-i,1)),h=!0}a.push({type:s,str:r}),i+=r.length,h&&(a.push({type:"ellipsis",str:" \u2026"}),i+=2)}}const $={},W=R({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>$}},setup(e){const{locales:o}=D(e),a=b(""),i=b(!1),u=b(-1),l=J(a),c=L(()=>a.value&&i.value&&l.value.length),n=N(),t=U(),s=L(()=>{var g;return(g=o.value[t.value])!=null?g:{}});function r(){if(!c.value)return;let g=u.value-1;g<0&&(g=l.value.length-1),f(g)}function h(){if(!c.value)return;let g=u.value+1;g>=l.value.length&&(g=0),f(g)}function f(g){u.value=g}function S(){u.value=-1}function _(g){if(!c.value)return;const O=l.value[g];O&&n.push(O.path)}return{query:a,focused:i,focusIndex:u,suggestions:l,activeSuggestion:c,onUp:r,onDown:h,focus:f,unfocus:S,go:_,locale:s}}}),Y={class:"search-box",role:"search"},q=["placeholder"],K=["onMousedown","onMouseenter"],V=["href"],Q={key:0,class:"parent-page-title"},X={class:"suggestion-row"},Z={class:"page-title"},ee={class:"suggestion-content"};function oe(e,o,a,i,u,l){var c;return p(),d("div",Y,[z(m("input",{ref:"input","onUpdate:modelValue":o[0]||(o[0]=n=>e.query=n),"aria-label":"Search",class:y({focused:e.focused}),placeholder:(c=e.locale.placeholder)!=null?c:"Search",autocomplete:"off",spellcheck:"false",onFocus:o[1]||(o[1]=()=>e.focused=!0),onBlur:o[2]||(o[2]=()=>e.focused=!1),onKeyup:[o[3]||(o[3]=k(n=>e.go(e.focusIndex),["enter"])),o[4]||(o[4]=k((...n)=>e.onUp&&e.onUp(...n),["up"])),o[5]||(o[5]=k((...n)=>e.onDown&&e.onDown(...n),["down"]))]},null,42,q),[[H,e.query]]),e.activeSuggestion?(p(),d("ul",{key:0,class:"suggestions",onMouseleave:o[7]||(o[7]=(...n)=>e.unfocus&&e.unfocus(...n))},[(p(!0),d(G,null,I(e.suggestions,(n,t)=>(p(),d("li",{key:t,class:y(["suggestion",{focused:t===e.focusIndex}]),onMousedown:s=>e.go(t),onMouseenter:s=>e.focus(t)},[m("a",{href:n.path,onClick:o[6]||(o[6]=M(()=>{},["prevent"]))},[n.parentPageTitle&&(!e.suggestions[t-1]||e.suggestions[t-1].parentPageTitle!==n.parentPageTitle)?(p(),d("div",Q,w(n.parentPageTitle),1)):A("",!0),m("div",X,[m("div",Z,w(n.title||n.path),1),m("div",ee,[(p(!0),d(G,null,I(n.display,(s,r)=>(p(),d("span",{key:r,class:y(s.type)},w(s.str),3))),128))])])],8,V)],42,K))),128))],32)):A("",!0)])}var ie=E(W,[["render",oe],["__scopeId","data-v-5cdeda06"],["__file","SearchBox.vue"]]);export{ie as default};

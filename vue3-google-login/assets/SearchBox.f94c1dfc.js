import{I as b,j as L,J as P,_ as E,f as D,p as R,O as U,u as N,o as p,c as d,K as z,$ as H,a as m,D as y,X as k,F as G,l as I,m as A,t as v,a0 as M}from"./app.2dfc7131.js";const te={},B=[{path:"/",title:"",pathLocale:"/",contents:[{header:"Vue 3 Google Login",content:""},{header:"Overview",slug:"overview",content:`This is a lightweight plugin to implement log-in and sign-up flows using Google Identity Services with the help of Google 3P Authorization JavaScript Library
...
</template>`},{header:"Nuxt 3",slug:"nuxt-3",content:""},{header:"Initialize vue3-google-login inside the plugins directory",slug:"initialize-vue3-google-login-inside-the-plugins-directory",content:`For example, create a file named vue3-google-login.client.ts and place it inside the plugins directory. \u2757 Make sure to use .client suffix in the file name to load the plugin only on the client side. import vue3GoogleLogin from 'vue3-google-login' export default defineNuxtPlugin((nuxtApp) => { nuxtApp.vueApp.use(vue3GoogleLogin, { clientId: 'YOUR_GOOGLE_CLIENT_ID' })
}); \u2757 While using GoogleLogin component, make sure it is wrapped inside <ClientOnly> component. <ClientOnly> <GoogleLogin :callback="callback" /> </ClientOnly>`},{header:"Options",slug:"options",content:""},{header:"Plugin options and GoogleLogin component props",slug:"plugin-options-and-googlelogin-component-props",content:`Options of plugin used at initializing in main.js and prop values in GoogleLogin component are similar. Name
Type
...
Description clientId
String
Google API client ID`}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],F="update-vuepress-plugin-full-text-search2-search-index";var C=b(B),j=L(()=>{const e=new Map;for(const o of C.value)e.set(o.path,o);return e});te.webpackHot&&(__VUE_HMR_RUNTIME__[F]=e=>{C.value=e});function J(e){const o=b([]);let a=null;return P(e,()=>{a&&clearTimeout(a),a=setTimeout(i,100)}),o;function i(){const u=e.value.toLowerCase().trim();if(!u){o.value=[];return}const l=new Map,c=new Set;for(const n of C.value)for(const s of $(n,u)){c.add(s.parentPageTitle);let r=l.get(s.parentPageTitle);r||(r=[],l.set(s.parentPageTitle,r)),r.push(s)}const t=[...c].sort((n,s)=>{const r=l.get(n);return l.get(s).length-r.length});o.value=[...l].flatMap(([,n])=>n).sort((n,s)=>n.parentPagePriority-s.parentPagePriority||t.indexOf(n.parentPageTitle)-t.indexOf(s.parentPageTitle)||n.priority-s.priority)}}function*$(e,o){const a=T(e.title,o);if(a){yield{path:e.path,parentPageTitle:w(e),title:e.title,display:a,page:e,content:null,parentPagePriority:1,priority:1};return}for(const i of e.contents){const u=T(i.header,o);if(u){yield{path:e.path+(i.slug?`#${i.slug}`:""),parentPageTitle:w(e),title:e.title,display:u,page:e,content:null,parentPagePriority:10,priority:2};continue}const l=T(i.content,o);l&&(yield{path:e.path+(i.slug?`#${i.slug}`:""),parentPageTitle:w(e),title:e.title,display:[{type:"header",str:`${i.header}
`},...l],page:e,content:null,parentPagePriority:10,priority:10})}}function w(e){const o=e.path.split("/");let a="/";return o[1]&&(a=`/${o[1]}/`),(j.value.get(a)||e).title}function T(e,o){const a=[];let i=0;const u=e.toLowerCase().replace(/\s/gu," ");let l=0,c=u.indexOf(o,l);if(c<0)return null;for(;c>=0;){const n=c+o.length;if(t(e.slice(l,c),"normal"),t(e.slice(c,n),"highlight"),l=n,c=u.indexOf(o,l),i>100)break}return t(e.slice(l),"normal"),a.filter(n=>n.str);function t(n,s){let r=n;s==="normal"&&r.length>100&&i===0&&(r=`\u2026 ${r.slice(-10)}`);let h=!1;if(i+r.length>100){if(a.some(f=>f.type==="ellipsis"))return;r=r.slice(0,Math.max(100-i,1)),h=!0}a.push({type:s,str:r}),i+=r.length,h&&(a.push({type:"ellipsis",str:" \u2026"}),i+=2)}}const x={},W=D({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>x}},setup(e){const{locales:o}=R(e),a=b(""),i=b(!1),u=b(-1),l=J(a),c=L(()=>a.value&&i.value&&l.value.length),t=U(),n=N(),s=L(()=>{var g;return(g=o.value[n.value])!=null?g:{}});function r(){if(!c.value)return;let g=u.value-1;g<0&&(g=l.value.length-1),f(g)}function h(){if(!c.value)return;let g=u.value+1;g>=l.value.length&&(g=0),f(g)}function f(g){u.value=g}function S(){u.value=-1}function _(g){if(!c.value)return;const O=l.value[g];O&&t.push(O.path)}return{query:a,focused:i,focusIndex:u,suggestions:l,activeSuggestion:c,onUp:r,onDown:h,focus:f,unfocus:S,go:_,locale:s}}}),K={class:"search-box",role:"search"},q=["placeholder"],V=["onMousedown","onMouseenter"],Y=["href"],X={key:0,class:"parent-page-title"},Z={class:"suggestion-row"},Q={class:"page-title"},ee={class:"suggestion-content"};function oe(e,o,a,i,u,l){var c;return p(),d("div",K,[z(m("input",{ref:"input","onUpdate:modelValue":o[0]||(o[0]=t=>e.query=t),"aria-label":"Search",class:y({focused:e.focused}),placeholder:(c=e.locale.placeholder)!=null?c:"Search",autocomplete:"off",spellcheck:"false",onFocus:o[1]||(o[1]=()=>e.focused=!0),onBlur:o[2]||(o[2]=()=>e.focused=!1),onKeyup:[o[3]||(o[3]=k(t=>e.go(e.focusIndex),["enter"])),o[4]||(o[4]=k((...t)=>e.onUp&&e.onUp(...t),["up"])),o[5]||(o[5]=k((...t)=>e.onDown&&e.onDown(...t),["down"]))]},null,42,q),[[H,e.query]]),e.activeSuggestion?(p(),d("ul",{key:0,class:"suggestions",onMouseleave:o[7]||(o[7]=(...t)=>e.unfocus&&e.unfocus(...t))},[(p(!0),d(G,null,I(e.suggestions,(t,n)=>(p(),d("li",{key:n,class:y(["suggestion",{focused:n===e.focusIndex}]),onMousedown:s=>e.go(n),onMouseenter:s=>e.focus(n)},[m("a",{href:t.path,onClick:o[6]||(o[6]=M(()=>{},["prevent"]))},[t.parentPageTitle&&(!e.suggestions[n-1]||e.suggestions[n-1].parentPageTitle!==t.parentPageTitle)?(p(),d("div",X,v(t.parentPageTitle),1)):A("",!0),m("div",Z,[m("div",Q,v(t.title||t.path),1),m("div",ee,[(p(!0),d(G,null,I(t.display,(s,r)=>(p(),d("span",{key:r,class:y(s.type)},v(s.str),3))),128))])])],8,Y)],42,V))),128))],32)):A("",!0)])}var ie=E(W,[["render",oe],["__scopeId","data-v-5cdeda06"],["__file","SearchBox.vue"]]);export{ie as default};

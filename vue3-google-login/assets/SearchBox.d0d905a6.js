import{I as y,j as L,J as P,_ as D,f as E,p as N,u as R,o as p,c as d,K as U,$ as x,a as m,D as b,X as k,F as O,l as I,m as S,O as z,t as v,a0 as M}from"./app.4cd6336b.js";const te={},H=[{path:"/",title:"",pathLocale:"/",contents:[{header:"Vue 3 Google Login - Complete Documentation",content:""},{header:"Overview",slug:"overview",content:`vue3-google-login is a lightweight, production-ready Vue 3 plugin for implementing Google Sign In, Google authentication, and OAuth2 login flows in your Vue 3 applications. This package provides seamless integration with Google Identity Services and the Google 3P Authorization JavaScript Library, making it easy to add Google login functionality to your Vue 3 projects.
...
`},...l],page:e,content:null,parentPagePriority:10,priority:10})}}function w(e){const o=e.path.split("/");let a="/";return o[1]&&(a=`/${o[1]}/`),(V.value.get(a)||e).title}function T(e,o){const a=[];let i=0;const c=e.toLowerCase().replace(/\s/gu," ");let l=0,u=c.indexOf(o,l);if(u<0)return null;for(;u>=0;){const n=u+o.length;if(t(e.slice(l,u),"normal"),t(e.slice(u,n),"highlight"),l=n,u=c.indexOf(o,l),i>100)break}return t(e.slice(l),"normal"),a.filter(n=>n.str);function t(n,s){let r=n;s==="normal"&&r.length>100&&i===0&&(r=`\u2026 ${r.slice(-10)}`);let h=!1;if(i+r.length>100){if(a.some(f=>f.type==="ellipsis"))return;r=r.slice(0,Math.max(100-i,1)),h=!0}a.push({type:s,str:r}),i+=r.length,h&&(a.push({type:"ellipsis",str:" \u2026"}),i+=2)}}const Y={},J=E({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>Y}},setup(e){const{locales:o}=N(e),a=y(""),i=y(!1),c=y(-1),l=F(a),u=L(()=>a.value&&i.value&&l.value.length),t=z(),n=R(),s=L(()=>{var g;return(g=o.value[n.value])!=null?g:{}});function r(){if(!u.value)return;let g=c.value-1;g<0&&(g=l.value.length-1),f(g)}function h(){if(!u.value)return;let g=c.value+1;g>=l.value.length&&(g=0),f(g)}function f(g){c.value=g}function A(){c.value=-1}function _(g){if(!u.value)return;const C=l.value[g];C&&t.push(C.path)}return{query:a,focused:i,focusIndex:c,suggestions:l,activeSuggestion:u,onUp:r,onDown:h,focus:f,unfocus:A,go:_,locale:s}}}),K={class:"search-box",role:"search"},q=["placeholder"],$=["onMousedown","onMouseenter"],W=["href"],Q={key:0,class:"parent-page-title"},X={class:"suggestion-row"},Z={class:"page-title"},ee={class:"suggestion-content"};function oe(e,o,a,i,c,l){var u;return p(),d("div",K,[U(m("input",{ref:"input","onUpdate:modelValue":o[0]||(o[0]=t=>e.query=t),"aria-label":"Search",class:b({focused:e.focused}),placeholder:(u=e.locale.placeholder)!=null?u:"Search",autocomplete:"off",spellcheck:"false",onFocus:o[1]||(o[1]=()=>e.focused=!0),onBlur:o[2]||(o[2]=()=>e.focused=!1),onKeyup:[o[3]||(o[3]=k(t=>e.go(e.focusIndex),["enter"])),o[4]||(o[4]=k((...t)=>e.onUp&&e.onUp(...t),["up"])),o[5]||(o[5]=k((...t)=>e.onDown&&e.onDown(...t),["down"]))]},null,42,q),[[x,e.query]]),e.activeSuggestion?(p(),d("ul",{key:0,class:"suggestions",onMouseleave:o[7]||(o[7]=(...t)=>e.unfocus&&e.unfocus(...t))},[(p(!0),d(O,null,I(e.suggestions,(t,n)=>(p(),d("li",{key:n,class:b(["suggestion",{focused:n===e.focusIndex}]),onMousedown:s=>e.go(n),onMouseenter:s=>e.focus(n)},[m("a",{href:t.path,onClick:o[6]||(o[6]=M(()=>{},["prevent"]))},[t.parentPageTitle&&(!e.suggestions[n-1]||e.suggestions[n-1].parentPageTitle!==t.parentPageTitle)?(p(),d("div",Q,v(t.parentPageTitle),1)):S("",!0),m("div",X,[m("div",Z,v(t.title||t.path),1),m("div",ee,[(p(!0),d(O,null,I(t.display,(s,r)=>(p(),d("span",{key:r,class:b(s.type)},v(s.str),3))),128))])])],8,W)],42,$))),128))],32)):S("",!0)])}var ie=D(J,[["render",oe],["__scopeId","data-v-5cdeda06"],["__file","SearchBox.vue"]]);export{ie as default};

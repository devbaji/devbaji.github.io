...
</template>`},{header:"Nuxt 3",slug:"nuxt-3",content:""},{header:"Using the official Nuxt module (recommended)",slug:"using-the-official-nuxt-module-recommended",content:`The easiest way to use vue3-google-login in a Nuxt 3 app is via the official nuxt-vue3-google-login module. It handles SSR safety, auto-imports components and utility functions, and requires zero boilerplate.

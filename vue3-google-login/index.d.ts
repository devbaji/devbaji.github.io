...
interface GoogleAuthCodeLogin {
    (clientId?: ClientId): Promise<CodePopupResponse>;
}
/**
...
interface GoogleTokenLogin {
    (clientId?: ClientId): Promise<TokenPopupResponse>;
}
 ...
 */
declare const useGoogleSdkLoaded: () => Ref<boolean>;
declare const _default: {
    install: (app: App, options: Options) => void;
};

export { callbackTypes_d as CallbackTypes, _default$1 as GoogleLogin, decodeCredential, _default as default, googleAuthCodeLogin, googleLogout, googleOneTap, googleSdkLoaded, googleTokenLogin, useGoogleSdkLoaded };
